...
@section('content_header')
    <h4 class="text-dark pl-2">User Management</h4>
@stop
                            ...
                            <div class="col-lg-12">
                                <section class="content">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" action="{{ route('admin.users.update', ['item' => $item]) }}" method="POST" autocomplete="off">
                                                @csrf                        
                                                <div class="row">    
                                                    @include('admin.users.form.index', ['readonly'=>''])

                                                    <div class="col-lg-12" style="margin-top: 25px;">
                                                        <div class="form-group text-right">
                                                            <a class="btn btn-secondary" href="{{ route('admin.users.index') }}">Back</a>
                                                            <button type="submit" class="btn btn-success create-user_btn">Edit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
