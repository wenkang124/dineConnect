                            ...
                            <div class="col-lg-12">
                                <section class="content">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" action="{{ route('admin.users.store') }}" method="POST" autocomplete="off">
                                                @csrf                        
                                                <div class="row">    
                                                    ...
                                                    <div class="col-lg-12" style="margin-top: 25px;">
                                                        <div class="form-group text-right">
                                                            ...
                                                            <button type="submit" class="btn btn-success create-user_btn">Add</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
