    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">New Merchant</li>
            </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <section class="content">
                                    <!-- Default box -->
                                    <form class="form-horizontal" action="{{ route('admin.merchants.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                        @csrf                  
                                        <div class="row">
