    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.merchants.sub_categories.index')}}">Merchant Sub Categories</a></li>
                            ...
                            <div class="col-lg-12">
                                <section class="content">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" action="{{ route('admin.merchants.sub_categories.update', ['item' => $item]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                @csrf                        
                                                <div class="row">    
