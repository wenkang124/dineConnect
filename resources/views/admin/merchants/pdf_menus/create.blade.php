...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">   
            <h5>Create New Merchant PDF Menu</h5>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">New Merchant PDF Menu</li>
            </ol>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-lg-12">
                                <section class="content">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" action="{{ route('admin.merchant_pdf_menus.store', ['merchant_id'=>$merchant_id]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                @csrf                        
                                                <div class="row">    
